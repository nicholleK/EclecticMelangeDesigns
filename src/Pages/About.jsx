  ...
  <div className="col-md-6  d-none d-md-block ">
    ...
    <h1 className='service-heading'>What We Provide</h1>
      ...
      <div className="row">
        ...
        <Card >
        <Card.Img  variant='top' src='\Images\essentials\undraw_interior-design_j887.svg'/>
        <Card.Body>
        ...
        <div className="col-12 col-md-4 col-lg-4  top-left ">
        <Card >
        <Card.Img  variant='top' src='\Images\essentials\undraw_progressive-app_9517.svg'/>
        <Card.Body>
        ...
        <Card>
        <Card.Img variant='top' src='\Images\essentials\undraw_design-sprint_7mmb.svg'/>
        <Card.Body>
      ...
      <div className="row">
        ...
        <Card>
        <Card.Img variant='top' src='\Images\essentials\undraw_responsive_csbt.svg'/>
        <Card.Body>
        ...
        <div className="col-12 col-md-4 col-lg-4 ">
        <Card>
        <Card.Img variant='top' src='\Images\essentials\undraw_product-photography_pouq.svg'/>
        <Card.Body>
        ...
        <div className="col-12 col-md-4 col-lg-4 ">
        <Card>
        <Card.Img variant='top' src='\Images\essentials\undraw_events_0w4f.svg'/>
        <Card.Body>
